...
export const services = [
  {
    ...
    description: "Revitalize and protect your home’s exterior with a fresh, high-quality coat of paint.",
  ...
  },
  {
    ...
    description: "Transform your indoor spaces with vibrant, lasting colors and a flawless finish.",
  ...
  },
  {
    ...
    description: "Turn your basement into a beautiful and functional living space, from framing to final touches.",
  ...
  },
  {
    ...
    shortName: "Wallpaper",
    description: "Add elegance and personality to your walls with professional wallpaper installation.",
    href: "/services/wallpaper-installation",
    icon: FileText,
    image: "https://images.unsplash.com/photo-1560416943-d7fb37c3b214?w=600&h=400&fit=crop",
    features: [
  ...
  },
  {
    ...
    description: "A cost-effective way to modernize your kitchen or bathroom with a durable, factory-like finish.",
  ...
  },
  {
    ...
    description: "Protect and enhance the natural beauty of your deck with professional staining and sealing.",
    href: "/services/deck-staining",
    icon: Code, // Using 'Code' as a placeholder, can be changed
    image: "https://images.unsplash.com/photo-1593436122512-0f3733a1401a?w=600&h=400&fit=crop",
    features: [
